...
function vue(opts = {}) {
    ...
    createVuePartRequest.defaultLang = Object.assign(Object.assign({}, createVuePartRequest.defaultLang), opts.defaultLang);
    ...
    const getCompiler = ({ scopeId }) => {
        ...
        options.template = Object.assign(Object.assign({}, options.template), { compilerOptions: Object.assign(Object.assign({}, (options.template.compilerOptions
    ...
    return {
        ...
        load(id) {
            ...
            if (request.meta.type === 'styles') {
                code = prependStyle(id, request.meta.lang, code).code;
            }
                    ...
                    if (shouldExtractCss) {
                        input.styles = input.styles
                            ...
                            if (style.module || descriptor.styles[index].scoped) {
                                return Object.assign(Object.assign({}, style), { code: '', map: undefined });
                            }
                        })
                            .filter(Boolean);
                    }
...
export default vue;
//# sourceMappingURL=rollup-plugin-vue.esm.js.map
